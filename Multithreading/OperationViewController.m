...
//    [self creatOperationQueue2];
    ...
    //设置挂起
//    [self operationSetSuspended];
    
    //设置依赖
//    [self createOperationQueueSetDependency];

    
    [self createOperationQueueShowImage];
}
...
//    queue.maxConcurrentOperationCount = 1;  //设置为1就成了串行队列
...
-(void)createOperationQueueSetDependency{
...
#pragma mark-线程间的通信
-(void)createOperationQueueShowImage{
